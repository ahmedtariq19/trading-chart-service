...
const (
	CandlestickService_StreamCandlesticks_FullMethodName = "/tradingchart.CandlestickService/StreamCandlesticks"
)
...
type CandlestickServiceClient interface {
	StreamCandlesticks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Candlestick], error)
}
...
func (c *candlestickServiceClient) StreamCandlesticks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Candlestick], error) {
	...
	x := &grpc.GenericClientStream[Empty, Candlestick]{ClientStream: stream}
...
type CandlestickServiceServer interface {
	StreamCandlesticks(*Empty, grpc.ServerStreamingServer[Candlestick]) error
...
func (UnimplementedCandlestickServiceServer) StreamCandlesticks(*Empty, grpc.ServerStreamingServer[Candlestick]) error {
...
func _CandlestickService_StreamCandlesticks_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CandlestickServiceServer).StreamCandlesticks(m, &grpc.GenericServerStream[Empty, Candlestick]{ServerStream: stream})
}
...
var CandlestickService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tradingchart.CandlestickService",
